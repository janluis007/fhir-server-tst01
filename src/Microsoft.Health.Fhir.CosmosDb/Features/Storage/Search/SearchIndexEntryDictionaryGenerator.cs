...
{
    internal class SearchIndexEntryDictionaryGenerator : ISearchValueVisitor
    {
        private readonly List<Dictionary<string, object>> _generatedObjects = new List<Dictionary<string, object>>();

        public SearchIndexEntryDictionaryGenerator()
        {
        }
        ...
        private Dictionary<string, object> CurrentEntry { get; set; }

        public IReadOnlyList<IReadOnlyDictionary<string, object>> Generate(SearchIndexEntry entry)
        {
        ...
        private void CreateEntry()
        {
            ...
            {
                { SearchValueConstants.ParamName, Entry.SearchParameter.Name },
            };
