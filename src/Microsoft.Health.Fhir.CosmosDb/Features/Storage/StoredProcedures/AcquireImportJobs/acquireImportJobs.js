/**
* This stored procedure acquires list of available import jobs. 
* 
* @constructor
...
function acquireImportJobs(maximumNumberOfConcurrentJobsAllowedInString, jobHeartbeatTimeoutThresholdInSecondsInString) {
