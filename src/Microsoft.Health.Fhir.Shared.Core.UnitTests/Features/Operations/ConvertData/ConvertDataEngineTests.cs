...
namespace Microsoft.Health.Fhir.Shared.Core.UnitTests.Features.Operations.ConvertData
{
    public class ConvertDataEngineTests
    {
        ...
        {
            return new ConvertDataRequest(Samples.SampleHl7v2Message, Liquid.Converter.Models.DataType.Hl7v2, "microsofthealth", true, GetDefaultTemplateImageReferenceByDataType(Liquid.Converter.Models.DataType.Hl7v2), "ADT_A01");
        }

        private static ConvertDataRequest GetCcdaRequestWithDefaultTemplates()
        {
            return new ConvertDataRequest(Samples.SampleCcdaMessage, Liquid.Converter.Models.DataType.Ccda, "microsofthealth", true, GetDefaultTemplateImageReferenceByDataType(Liquid.Converter.Models.DataType.Ccda), "CCD");
        }

        private static ConvertDataRequest GetHl7V2RequestWithTemplateReference(string imageReference)
        {
            return new ConvertDataRequest(Samples.SampleHl7v2Message, Liquid.Converter.Models.DataType.Hl7v2, imageReference.Split('/')[0], false, imageReference, "ADT_A01");
        }

        private static ConvertDataRequest GetCcdaRequestWithTemplateReference(string imageReference)
        {
            return new ConvertDataRequest(Samples.SampleCcdaMessage, Liquid.Converter.Models.DataType.Ccda, imageReference.Split('/')[0], false, imageReference, "CCD");
        }

        private static ConvertDataRequest GetHl7V2RequestWithInputData(string inputData)
        {
            return new ConvertDataRequest(inputData, Liquid.Converter.Models.DataType.Hl7v2, "microsofthealth", true, GetDefaultTemplateImageReferenceByDataType(Liquid.Converter.Models.DataType.Hl7v2), "ADT_A01");
        }

        private static ConvertDataRequest GetCcdaRequestWithInputData(string inputData)
        {
            return new ConvertDataRequest(inputData, Liquid.Converter.Models.DataType.Ccda, "microsofthealth", true, GetDefaultTemplateImageReferenceByDataType(Liquid.Converter.Models.DataType.Ccda), "CCD");
        }

        private static ConvertDataRequest GetHl7V2RequestWithRootTemplate(string rootTemplate)
        {
            return new ConvertDataRequest(Samples.SampleHl7v2Message, Liquid.Converter.Models.DataType.Hl7v2, "microsofthealth", true, GetDefaultTemplateImageReferenceByDataType(Liquid.Converter.Models.DataType.Hl7v2), rootTemplate);
        }

        private static ConvertDataRequest GetCcdaRequestWithRootTemplate(string rootTemplate)
        {
            return new ConvertDataRequest(Samples.SampleCcdaMessage, Liquid.Converter.Models.DataType.Ccda, "microsofthealth", true, GetDefaultTemplateImageReferenceByDataType(Liquid.Converter.Models.DataType.Ccda), rootTemplate);
        }
